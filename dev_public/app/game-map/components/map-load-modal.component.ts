import {Component, OnInit, HostBinding, ViewContainerRef, Renderer, ElementRef, HostListener} from '@angular/core';
...
export class MapLoadModalComponent extends Modal implements OnInit {
    ...
    constructor(private mapService: MapService, private mapCreator: MapCreator, private ref: ElementRef, private renderer: Renderer, private mapLoadService: MapLoadService) {
        super();
        this.checkIsMobile();
